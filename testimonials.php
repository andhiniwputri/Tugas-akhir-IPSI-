    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="course.php">Modul Pembelajarna</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>mathedukid</h3>
              <p>
                Jl. Alumni No.3, Padang Bulan, Medan Baru, Kota Medan, Sumatra Utara 20155 <br>
                NY 535022, USA<br><br>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Modul Pembelajaran</a></li>
