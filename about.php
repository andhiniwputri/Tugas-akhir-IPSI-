        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/andhini.jpeg" class="img-fluid" alt="" ></div>
              <div class="member-info">
                <h4>Andhini Widyasari</h4>
                <span>Programer & Designer</span>
                <p></p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/jalpa.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Latisya Zalfa</h4>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/yasmine.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Yasmin Ambar</h4>
                <span>System Engineer</span>
                <p></p>
